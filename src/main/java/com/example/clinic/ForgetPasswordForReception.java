...
public class ForgetPasswordForReception extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_password_for_reception);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                organdb = FirebaseDatabase.getInstance().getReference().child("patientSignupInfo");
